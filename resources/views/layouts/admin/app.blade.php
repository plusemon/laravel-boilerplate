                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box text-center">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/admin') }}/images/logo-sm.png" alt="logo-sm-dark" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/admin') }}/images/logo-dark.png" alt="logo-dark" height="24">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/admin') }}/images/logo-light.png" alt="logo-light" height="24">
                                </span>
                            </a>
                        </div>
